...
exports.tokenIsExist = tokenIsExist;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, authClient_1.pool.query(queries.checkIfIsExist, [token, expiry])];
                case 1:
                    result = _a.sent();
...
function getCredentials(token, expiry) {
    return __awaiter(this, void 0, void 0, function () {
        var result, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, authClient_1.pool.query(queries.getByToken, [token, expiry])];
                case 1:
                    result = _a.sent();
...
function setCredentials(token, value) {
    return __awaiter(this, void 0, void 0, function () {
        var result, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, authClient_1.pool.query(queries.insertNewRow, [token, value])];
                case 1:
                    result = _a.sent();
...
function isLogined(token, expiry) {
    return __awaiter(this, void 0, void 0, function () {
        var result, err_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, authClient_1.pool.query(queries.isLogined, [token, expiry])];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result.rows];
                case 2:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, authClient_1.pool.query(queries.updateUserId, [userData, token])];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result];
                case 2:
