    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, authClient_1.pool.query(queries.isNotExpiried, [csrf, expiry])];
                case 1:
                    result = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, authClient_1.pool.query(queries.checkIfExist, [csrf])];
                case 1:
                    result = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, authClient_1.pool.query(queries.setCsrf, [token, csrf, expiry])];
                case 1:
                    result = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, authClient_1.pool.query(queries.updateCsrf, [csrf, expiry, token])];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result];
                case 2:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, authClient_1.pool.query(queries.selectByToken, [token, expiry])];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result.rows];
                case 2:
