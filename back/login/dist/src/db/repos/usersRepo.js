...
exports.setPincodeByEmail = setPincodeByEmail;
exports.comparePincode = comparePincode;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, usersClient_1.pool.query(queries.create, [user.email, user.data])];
                case 1:
                    result = _a.sent();
...
function setPincodeByEmail(email, pincode) {
    return __awaiter(this, void 0, void 0, function () {
        var result, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function comparePincode(email, pincode) {
    return __awaiter(this, void 0, void 0, function () {
        var result, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, usersClient_1.pool.query(queries.comparePincode, [email, pincode])];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result.rows];
                case 2:
