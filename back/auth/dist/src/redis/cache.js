        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    //     let expiry = credentialsValue.expiry;
                    //     if (expiry > Date.now()) {
                    //         if (credentialsValue.hasOwnProperty("userId")) {
                    //             if (csrf == credentialsValue.csrf) {
                    //                 console.log(csrf);
                    //                 let newCsrf = getCsrf();
                    //                 await updateCsrf({ csrf: newCsrf }, token);
                    //                 res.cookie("csrf", newCsrf, { httpOnly: true });
                    //                 res.send(true);
                    //             } else {
                    //                 res.send(false);
                    //             }
