        ...
        ele: "main", css: ["main", "hidden"], classList: [], childs: [
            {
                ele: "div", classList: ["loginContainer"], childs: [
                    {
                        ele: "form", css: ["hidden", "invisible"], classList: ["loginContainerForm"], options: { id: "login-form" }, childs: [
                            {
                    ...
                    {
                        ele: "form", css: [], classList: ["loginContainerForm"], options: { id: "register-form" }, childs: [
                            {
                                ele: "div", classList: ["loginContainerInputContainer"], childs: [
